...
with open('Bond.json', 'r') as file_with_data:
...
for key, message in data.items():
    ...
    # print(re.search(re_city, message))
#
# pprint(dates)
# pprint(cities)
...
#
#
with open('BondDetail.csv', 'w', encoding='utf8') as out_detail_file:
...
#
#
with open('BondByMonth.csv', 'w', encoding='utf8') as out_monthly_file:
